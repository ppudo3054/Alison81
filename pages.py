...
<div class="wrap">
  ...
  <div class="foot">ALISON Network Console &copy; <span data-i18n="rights"></span></div>
</div>
...
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>ALISON Network Console</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
...
<style>.ib-card-links{display:grid;gap:7px;margin:10px 0;padding:10px;border:1px solid rgba(112,255,230,.08);border-radius:12px;background:rgba(0,0,0,.16)}.grp-inline{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:7px;align-items:center}.grp-inline span{font-size:10px;color:#78948e}.grp-inline code{font:10px monospace;color:#bcefe5;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;direction:ltr;text-align:left}.grp-inline .iconbtn{width:30px;height:30px}</style>
</head>
<body>
<script>(function(){
...
<div id="app">
  ...
  <div class="body-wrap">
    ...
    <div class="page on" id="pg-overview">
      <div class="pg-head"><div><div class="eyebrow"><span class="live-dot"></span> ALISON LIVE SYSTEM</div><h1>کنسول ALISON</h1><p>نمای لحظه‌ای منابع سرور، ترافیک، اتصال‌ها و سرویس فروش.</p></div>
    ...
    <div class="page" id="pg-settings">
      ...
      <div class="appearance-studio">
        ...
        <div class="appearance-card appearance-preview"><div class="preview-window"><div class="preview-top"><i class="ti ti-circle-filled"></i><i class="ti ti-circle-filled"></i><i class="ti ti-circle-filled"></i></div><div class="preview-main"><div class="preview-side"><div class="active"></div><div></div><div></div><div></div></div><div class="preview-content"><div class="pv-title">ALISON Network Console</div><div class="pv-sub">Live network overview</div><div class="pv-cards"><span></span><span></span><span></span></div></div></div></div></div>
      </div>
...
const DASH_EN_TERMS = {
  ...
  'مرکز کنترل':'Network Console','مرکز پیام و خطا':'Message & Error Center','مدیریت حساب‌ها':'Admin Management','مدیریت حساب':'Admin Management',
...
function ibCardHtml(l){
  ...
  return `<article class="ib-card ${l.active?'':'ib-off'}" data-uid="${l.uuid}">
    ...
    <div class="ib-card-stats">
      <div><small>قیمت</small><b>${Number(l.price_stars||0)>0?'⭐ '+Number(l.price_stars):'رایگان'}</b></div>
    ...
    <div class="ib-card-links"><div class="grp-inline"><span>لینک کانفیگ</span><code>${escapeHtml(l.vless_full||l.vless||'—')}</code><button class="iconbtn" title="کپی لینک کانفیگ" onclick="copyText(${escapeHtml(JSON.stringify(l.vless_full||l.vless||''))})"><i class="ti ti-copy"></i></button></div><div class="grp-inline"><span>لینک اشتراک</span><code>${escapeHtml(l.sub||l.sub_url||'—')}</code><button class="iconbtn" title="کپی لینک اشتراک" onclick="copyText(${escapeHtml(JSON.stringify(l.sub||l.sub_url||''))})"><i class="ti ti-link"></i></button></div></div>
      ...
      <div class="ib-section">
        ...
        <div class="ib-section-body">
          <div class="ib-grid">
            ...
            <div class="grp"><label>قیمت کانفیگ (⭐ Stars)</label><input id="fPriceStars" type="number" min="0" max="100000000" value="${l.price_stars||0}" placeholder="0 = بدون قیمت"></div>
